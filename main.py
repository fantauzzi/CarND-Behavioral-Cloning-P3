...
log = model.fit_generator(train_generator, steps_per_epoch=math.ceil(len(train_samples)//batch_size),
                    validation_data=validation_generator, validation_steps=len(validation_samples), epochs=10, verbose=2,
                    workers=1)
end_time = time.time()
